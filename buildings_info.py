...
def get_buildings_info(json_addresses, url):
    ...
    :return:
    """
    if os.path.exists("files/buildings_info.json"):
        with open('files/buildings_info.json', 'r') as json_file:
    ...
    for key, value in json_addresses.items():
        ...
        for street in streets:
            ...
            for article in street_addresses:
                ...
                num_building = "".join([i for i in num_building if i.isdigit() or i.isalpha()])
